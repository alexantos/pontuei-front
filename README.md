...
Esse projeto roda em conjunto com seu back ([pontuei-back](https://github.com/alexantos/pontuei-back)). Ele registra a pontuação dos jogadores em cada partida de um jogo (de baralho por exemplo).
...
Para rodar o projeto é necessário ter o node instalado, clonar o projeto e rodar:
```bash
npm install
```
